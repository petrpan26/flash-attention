 ...
 * Grouped flash attention kernel instantiation for fp16, headdim 96, sm80+
 ******************************************************************************/
...
template<>
void run_mha_fwd_grouped_<cutlass::half_t, 96, false>(Flash_fwd_params &params, cudaStream_t stream) {
...
template<>
void run_mha_fwd_grouped_<cutlass::half_t, 96, true>(Flash_fwd_params &params, cudaStream_t stream) {
    constexpr static int Headdim = 96;
