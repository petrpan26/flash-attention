    ...
    ext_modules.append(
        CUDAExtension(
            ...
            sources=[
                ...
                # Building grouped kernels with SMEM K,V sharing (ALL HEAD DIMENSIONS)
                "csrc/flash_attn/src/flash_fwd_hdim128_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_hdim128_bf16_sm80.cu",
                # Grouped kernels for all head dimensions (32, 64, 96, 128, 192, 256)
                "csrc/flash_attn/src/flash_fwd_grouped_hdim32_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim32_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim64_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim64_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim96_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim96_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim128_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim128_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim192_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim192_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim256_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_grouped_hdim256_bf16_sm80.cu",
                # Regular (non-grouped) forward kernels
                ...
                # Grouped backward kernels for all head dimensions (32, 64, 96, 128, 192, 256)
                "csrc/flash_attn/src/flash_bwd_grouped_hdim32_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim32_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim64_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim64_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim96_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim96_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim128_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim128_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim192_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim192_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim256_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_grouped_hdim256_bf16_sm80.cu",
